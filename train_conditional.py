...
import diffusers
from diffusers import DDPMPipeline, DDPMScheduler, UNet2DModel, AutoPipelineForText2Image
...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            labels = batch["label"].to(weight_dtype)  # Convert labels to tensor and move to appropriate device
